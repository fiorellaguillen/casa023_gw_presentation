...
<h3>Indonesia is building a $35 billion new capital  </h3> 
</div>
...
The capital will be moved from Jakarta to **Nusantara**, a city currently being built in a **forested area** of East Kalimantan province.
...
#<span style="font-size: 50px;">How this can be incorporated within existing work flow?</span>
...
- Depends heavily on quantitative case data, prioritizing reactive health interventions over proactive prevention measures.
- Overlooks spatial and socio-economic dimensions.
- Functions primarily within the health sector, missing opportunities for broader cross-sectoral insights such as urban planning.
<br/>
...
.pull-left[
   ...
   <div style="font-size: 20px; font-weight: bold"><strong>Short-Term (1 year)</strong></div>
        <hr />
        <div style="  font-size: 16px; text-align: justify">
      <ul>
            <li> The Risk Index can be used to prioritize immediate vector control measures in high-risk zones (e.g.,spraying mosquito-heavy areas, distributing insecticide-treated nets).
            </li>
             <br>
            <li>Set up temporary health posts in worker camps.</li>
...
.pull-right[
   ...
   <div style="font-size: 20px; font-weight: bold"><strong>Medium-Term (2-5 years)</strong></div>
        <hr />
          <div style="  font-size: 16px; line-height: 1; text-align: justify">

        <ul>
  <li> Incorporate malaria risk insights with city planning, aligning with Indonesia’s Spatial Planning Act, that  emphasizes integrating sectoral plans (e.g., health) with spatial strategies <a href="https://www.mlit.go.jp/kokudokeikaku/international/spw/general/indonesia/index_e.html">Source</a>.</li>
   <ul> <li>Land Use Planning.</li>
    <li>Infrastructure Design.</li>
    <li>Health Facility Placement.</li>
      </ul> 
      <br>
       <li>Link malaria risk maps to current tools like SISMAL, adding spatial depth that enhances tracking and outbreak control  </li>
      </ul>
          </div>
    </div>
]
  <div style=" padding: 10px; font-size: 16px; text-align: justify">
        ...
        <hr />
        <ul>
            <li>Embed malaria risk into Nusantara’s master plan for sustainable urban development to ensuret that future expansions are <strong>malaria-resilient. </strong>.</li>
<li> Integrate live monitoring with real-time earth observation data for adaptive malaria control as the city grows.
           </li>        </ul>
    </div>
