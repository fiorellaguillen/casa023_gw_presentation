...
.panel[.panel-name[Provincial Regulation]
.pull-left[
<small><span style="font-size: 100%;"> By 2027, the Provincial Government plans to eliminate malaria based on regional endemicity levels. </span></small>

<small><span style="font-size: 75%;">
* **High endemicity levels** : decrease the annual incidence to less than **5** cases per 1,000 people <br>
* **Medium endemicity levels**, decrease the annual incidence to less than **1** cases per 1,000 people <br>
* **Low endemicity levels**, stop local transmission until they receive a Malaria Elimination Certificate <br>
* **Free-malaria area** : maintain malaria-free status </span></small>

]
.pull-right[
<img src="images/Picture6.png" style="width: 250px; height: auto;">
<figcaption style="text-align: center; font-size: 12px;">
 <a> Source: Regulation 58/2023 </a>
</figcaption>
]
]
.panel[.panel-name[Tangible Action : WHO Framework]
.pull-left[
